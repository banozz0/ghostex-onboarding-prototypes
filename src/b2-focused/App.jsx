// PROTOTYPE B2 — flow shell: stage scaling, chrome, navigation and the one shared state.
...
// the stage edge: no divider, and the nebula's flat left field covers the whole stage.
  ...
  return (
    <div className="page">
      ...
      <div className="proto-pill">
        <span>Prototype B2 · Focused</span>
